...
public class Car extends Transport {
    ...
    public Car(String engine, String wheel, String color, String name, String type, String numberCar) {
        ...
        this.wheels = new Wheel();//можно добавить радус и шины будут одинаковые
    }
    ...
    @Override
    public int hashCode() {
        return 31 * (engine.hashCode() + wheel.hashCode() + color.hashCode() + numberCar.hashCode()
                + name.hashCode() + type.hashCode() + wheels.hashCode());
    }
}
